...
Feature: Attacking
  ...
  Scenario Outline: AttackSuccessful
    ...
    Then player <player_attacking>'s species <species_attacking> now has a food count of <player_attacking_body_size>
    And player <player_under_attack>'s species <species_under_attack> now has a population of <final_player_2_population>
    Examples:
      | Num Players | num_player_1_species | num_player_2_species | player_attacking | species_attacking | player_under_attack | species_under_attack | initial_player_2_population | final_player_2_population | player_attacking_body_size |
      | 3           | 1                    | 1                    | 1                | 2                 | 1                   | 1                    | 1                           | 1                         | 1                          |
      | 3           | 2                    | 1                    | 2                | 3                 | 1                   | 1                    | 1                           | 1                         | 1                          |
      | 4           | 1                    | 1                    | 1                | 2                 | 1                   | 1                    | 1                           | 1                         | 1                          |
      | 4           | 3                    | 1                    | 3                | 4                 | 1                   | 1                    | 1                           | 1                         | 1                          |
